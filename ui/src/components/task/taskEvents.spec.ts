...
const EMITTERS: [any, string, string[]][] = [
    ...
    [TaskActions, 'TaskActions', ['authorize', 'order', 'complete', 'cancel', 'reopen', 'decide', 'set-strength', 'operator-hold']],
...
const DRAWER_EVENTS = ['open', 'human-review', 'human-signoff', 'operator-release', 'require-review',
    'authorize', 'order', 'complete', 'cancel', 'reopen', 'decide', 'set-strength', 'operator-hold']
...
const PAGE_ACTIONS: Record<string, string> = {
    ...
    answer: 'agentTaskAnswer', 'set-strength': 'agentTaskSetStrength', 'operator-hold': 'agentTaskOperatorHold',
}
