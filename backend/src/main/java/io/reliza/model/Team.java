...
@Entity
@Table(schema=ModelProperties.DB_SCHEMA, name="teams")
public class Team implements Serializable, RelizaEntity {
	private static final long serialVersionUID = 234792;
