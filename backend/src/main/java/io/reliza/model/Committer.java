...
/**
 * A natural person (or external bot) whose commits land in the org's
 * SCEs. Owns enrolled {@link SigningKey signing keys} the verifier
 * matches against. May or may not be bound to a ReARM user — see
 * {@link CommitterData} for the binding semantics.
 */
@Entity
@Table(schema = ModelProperties.DB_SCHEMA, name = "committers")
public class Committer implements Serializable, RelizaEntity {
	private static final long serialVersionUID = 234779;
