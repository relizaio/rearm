...
@Entity
@Table(schema = ModelProperties.DB_SCHEMA, name = "attestations")
public class Attestation implements Serializable, RelizaEntity {
	private static final long serialVersionUID = 981233L;
