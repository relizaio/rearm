...
/**
 * One verdict on one (subject, signature-artifact) pair. Subject is
 * an SCE in v1; the ARTIFACT slot is forward-looking for image / SBOM
 * signature attestations. See {@link SignatureVerificationData}.
 */
@Entity
@Table(schema = ModelProperties.DB_SCHEMA, name = "signature_verifications")
public class SignatureVerification implements Serializable, RelizaEntity {
	private static final long serialVersionUID = 234781;
