...
@Entity
@Table(schema=ModelProperties.DB_SCHEMA, name="users")
public class User implements Serializable, RelizaEntity {
	...
	private ZonedDateTime lastLogoutDate = ZonedDateTime.now();
	...
	public void setLastLogoutDate() {
		this.lastLogoutDate = ZonedDateTime.now();
	}
