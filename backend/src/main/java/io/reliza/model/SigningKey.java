...
/**
 * One enrolled public key bound to either an {@link Agent} or a
 * {@link Committer}. The verifier matches a signature by fingerprint
 * to find the enrolled key, then enforces the owner pointer. Never
 * trusts a key embedded in a signature blob.
 */
@Entity
@Table(schema = ModelProperties.DB_SCHEMA, name = "signing_keys")
public class SigningKey implements Serializable, RelizaEntity {
	private static final long serialVersionUID = 234780;
