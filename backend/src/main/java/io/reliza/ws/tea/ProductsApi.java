...
public interface ProductsApi {
     ...
     *
     * @param teiUrn Transparency Exchange Identifier (URN) (required)
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"totalResults\" : 1, \"pageStartIndex\" : 0, \"pageSize\" : 6, \"results\" : [ { \"components\" : [ null, null ], \"identifiers\" : [ { \"idType\" : \"cpe\", \"idValue\" : \"idValue\" }, { \"idType\" : \"cpe\", \"idValue\" : \"idValue\" } ], \"name\" : \"name\", \"uuid\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\" }, { \"components\" : [ null, null ], \"identifiers\" : [ { \"idType\" : \"cpe\", \"idValue\" : \"idValue\" }, { \"idType\" : \"cpe\", \"idValue\" : \"idValue\" } ], \"name\" : \"name\", \"uuid\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\" } ], \"timestamp\" : \"2024-03-20T15:30:00Z\" }";
