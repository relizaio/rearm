    ...
    <BasicLayout>
      ...
      <div className="mainPaddingContainer">
        ...
        <div className={`container-fluid ${styles.container4}`}>
          <ProfileContainer data={ourTeam} />
        </div>
        <div className={`container-fluid ${styles.container5}`}>
          <div className='row'>
            <h3 className={styles.C5_title1}>Leading brands trust Reliza for Teamwork Software</h3>
            <div className='col-12 d-flex justify-content-between flex-wrap'>
              {teamWorkSoftware?.map((item) => {
                return (
                  <img src={item?.icon} alt='' style={{ padding: "15px 10px" }} />
                )
              })}
            </div>
          </div>
        ...
        <div className={`container-fluid ${styles.container4}`}>
          <ProfileContainer data={ourBoard} />
        </div>
      </div>
      <LastContainer1 />
    </BasicLayout >
